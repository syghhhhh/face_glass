...
from run_vertical import run_ori
...
if __name__ == '__main__':
    ...
    main(args.input, args.output, os.path.join(args.glass, '20.jpg'), args.multithreading_thread_count)
    print(f'time cost -> {time.time() - time_start}')

    # python run_vertical_mul.py -i test_video/vertical.mp4 -o result_video/vertical_3.mp4
